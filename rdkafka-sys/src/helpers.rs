...
pub fn rd_kafka_resp_err_t_to_rdkafka_error(err: RDKafkaRespErr) -> RDKafkaErrorCode {
    match err {
        ...
        RD_KAFKA_RESP_ERR_INCONSISTENT_TOPIC_ID => InconsistentTopicId,
        RD_KAFKA_RESP_ERR_MISMATCHED_ENDPOINT_TYPE => MismatchedEndpointType,
        RD_KAFKA_RESP_ERR_UNSUPPORTED_ENDPOINT_TYPE => UnsupportedEndpointType,
        RD_KAFKA_RESP_ERR_UNKNOWN_CONTROLLER_ID => UnknownControllerId,
        RD_KAFKA_RESP_ERR_INVALID_REGISTRATION => InvalidRegistration,
        RD_KAFKA_RESP_ERR_TRANSACTION_ABORTABLE => TransactionAbortable,
        RD_KAFKA_RESP_ERR_INVALID_RECORD_STATE => InvalidRecordState,
        RD_KAFKA_RESP_ERR_SHARE_SESSION_NOT_FOUND => ShareSessionNotFound,
        RD_KAFKA_RESP_ERR_INVALID_SHARE_SESSION_EPOCH => InvalidShareSessionEpoch,
        RD_KAFKA_RESP_ERR_FENCED_STATE_EPOCH => FencedStateEpoch,
        RD_KAFKA_RESP_ERR_INVALID_VOTER_KEY => InvalidVoterKey,
        RD_KAFKA_RESP_ERR_DUPLICATE_VOTER => DuplicateVoter,
        RD_KAFKA_RESP_ERR_VOTER_NOT_FOUND => VoterNotFound,
        RD_KAFKA_RESP_ERR_INVALID_REGULAR_EXPRESSION => InvalidRegularExpression,
        RD_KAFKA_RESP_ERR_STREAMS_INVALID_TOPOLOGY => StreamsInvalidTopology,
        RD_KAFKA_RESP_ERR_STREAMS_INVALID_TOPOLOGY_EPOCH => StreamsInvalidTopologyEpoch,
        RD_KAFKA_RESP_ERR_STREAMS_TOPOLOGY_FENCED => StreamsTopologyFenced,
        RD_KAFKA_RESP_ERR_SHARE_SESSION_LIMIT_REACHED => ShareSessionLimitReached,
    }
}
