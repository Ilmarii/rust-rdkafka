...
extern "C" {
    pub fn rd_kafka_mock_request_new(
        id: i32,
        api_key: i16,
        timestamp: rd_ts_t,
    ) -> *mut rd_kafka_mock_request_t;
}
extern "C" {
...
extern "C" {
    pub fn rd_kafka_mock_request_timestamp(mreq: *mut rd_kafka_mock_request_t) -> rd_ts_t;
}
extern "C" {
